...
def MydataGeneratorTest(PathIDs, batch_size, samples_per_epoch):
    ...
    return X_batch, [y_Elev_OH, y_Azim_OH]
...
def MydataGenerator(PathIDs, batch_size, samples_per_epoch):
    ...
    while True: #generators for keras must be infinite
        ...
        yield X_batch, [y_Elev_OH, y_Azim_OH]#{'ElevPredict': y_batch_Elev, 'AzimuthPredict': y_batch_Azim} #y_batch_Elev, y_batch_Azim
...
[y_Elev_soft, y_Azim_soft] = model_final.predict(X_test) # predictions for Test data
#print(Ypred)
